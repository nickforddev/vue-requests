...
var init = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(vm, _config) {
    var config;
...
var makeMixin = (function (Vue, config) {
  return {
...
var VueRequest = function () {
  function VueRequest() {
    _classCallCheck(this, VueRequest);
  }

  _createClass(VueRequest, null, [{
    key: 'install',
