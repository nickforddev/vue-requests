...
function Request(
  ...
  const options = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.merge({}, defaults(), _options)
...
function processHeaders (default_headers, passed_headers) {
  let headers = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.merge({}, default_headers, passed_headers)
  ...
  headers = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.pickBy(headers, __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.identity)
...
const init = async (vm, _config) => {
  ...
  const config = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.merge({}, defaults, _config)
