...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_merge__ = __webpack_require__(0);
...
function Request(
  ...
  const options = __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()({}, defaults(), _options)
  const body = options.body
    ? JSON.stringify(options.body)
    : undefined

  const method = options.method
  const headers = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils__["a" /* processHeaders */])(config.headers, options.headers)
  ...
  const race = Promise.race([
    ...
    .then(__WEBPACK_IMPORTED_MODULE_2__utils__["b" /* handleXHRErrors */]),
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["c"] = validateArgs;
/* harmony export (immutable) */ __webpack_exports__["b"] = handleXHRErrors;
/* harmony export (immutable) */ __webpack_exports__["a"] = processHeaders;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_merge__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_merge__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_pickby__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_identity__ = __webpack_require__(6);
...
async function handleXHRErrors (response) {
...
function processHeaders (default_headers, passed_headers) {
  let headers = __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()({}, default_headers, passed_headers)
  ...
  headers = __WEBPACK_IMPORTED_MODULE_1_lodash_pickby___default()(headers, __WEBPACK_IMPORTED_MODULE_2_lodash_identity___default.a)
...
const init = async (vm, _config) => {
  try {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils__["c" /* validateArgs */])(_config)
  } catch (error) {
    console.warn(error)
  }
  const config = __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()({}, defaults, _config)
  vm.$request = async (url, options, hook = true) => {
    if (typeof config.before === 'function' && hook) {
      await config.before(vm)
    }
    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__request__["a" /* default */])(url, options, config)
  }
}

/* harmony default export */ __webpack_exports__["a"] = ((Vue, config) => ({
  beforeCreate() {
    init(this, config)
  }
}));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__request__ = __webpack_require__(1);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Request", function() { return __WEBPACK_IMPORTED_MODULE_1__request__["a"]; });



class VueRequest {
  static install(Vue, options) {
    Vue.mixin(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__mixin__["a" /* default */])(Vue, options))
  }
}
/* harmony export (immutable) */ __webpack_exports__["default"] = VueRequest;
